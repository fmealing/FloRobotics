...
class Album:
    ...
    Attributes:
        ...
        artist (Artist): hew artist responsible to  the album.
...
class Artist:
    ...
    Attributes:
        ...
        albums (list[album]): A list of the album by the artist.
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            if new_album is None:
                ...
                # just read a new album for a current artist
